...
<table>
     ...
     <div class="instaid">
          <div class="text"><a href="#" style="color:black;">@FarmFolio</a></div>

          <div class="gmailid">
               <a href="#" class="hypher" style="color:black;">FarmFolio6@gmail.com</a>
          </div>

     </div>
     <div class="copy">
          <h5 style="text-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2022 by www.FarmFolio.com</h5>
     </div>
